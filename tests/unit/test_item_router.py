...
def test_load_item_routes_returns_dict():
    ...
    from lit_monitor.core.item_router import ItemRoute, load_item_routes
...
def test_journal_article_routes_to_brain_build():
    ...
    from lit_monitor.core.item_router import get_route
...
def test_invalid_pipeline_value_raises(tmp_path):
    ...
    from lit_monitor.core.item_router import load_item_routes
